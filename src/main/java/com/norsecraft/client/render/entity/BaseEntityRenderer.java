...
public class BaseEntityRenderer<T extends LivingEntity & IAnimatable> extends GeoEntityRenderer<T> {

    public BaseEntityRenderer(EntityRendererFactory.Context ctx, AnimatedGeoModel<T> modelProvider) {
